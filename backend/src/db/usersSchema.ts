...
export const users = pgTable("users", {
  ...
  profileImg: varchar("profile_img", { length: 500 }).default(null), // Optional profile image URL
  bio: text("bio").default(null), // Optional short bio
  role: varchar('role', { length: 50 }).default('customer').notNull(), // Role: customer, admin, etc.
  phone: varchar("phone", { length: 15 }).default(null), // Optional phone number
