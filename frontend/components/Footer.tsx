...
const YouTubeIcon = () => (
  <Svg width={IconSize} height={IconSize} viewBox="0 0 24 24" fill="black">
  ...
  return (
    <View className="pt-16 gap-7 pb-5 bg-white">
      <View className="flex-row items-center justify-center gap-12">
        ...
        <Text className="text-xl font-semibold text-black">Blog</Text>
      </View>
      <View className=" flex items-center justify-center gap-1.5">
        <Text className="text-lg ">support@stylesage.design</Text>
        <Text className="text-lg "> (229) 555-0109</Text>
        <Text className="text-lg "> 07:00 - 21:00 - Everyday</Text>
      </View>
      <View className="flex-row items-center justify-center gap-7">
        <TouchableOpacity onPress={() => console.log('YouTube pressed')}>
          <YouTubeIcon />
        </TouchableOpacity>
      ...
      <Text className="text-center">Copyright© StyleSage All Rights Reserved.</Text>
    </View>
  );
};
